            ...
            <tbody>
              <tr v-if="isLoading">
                <td colspan="5" class="empty-state">
                  ...
                  <p>Dang tai du lieu nguoi dung...</p>
                </td>
              </tr>
              ...
              <tr v-for="(item, index) in filteredUsers" :key="item.id" class="table-row">
                ...
                <td>
                  <div class="user-cell">
                    <div class="avatar-wrapper mini-avatar">
                      <img v-if="item.anh_dai_dien" :src="item.anh_dai_dien" :alt="item.ten" class="avatar-image">
                ...
                <td>
                  <span class="info-text">{{ item.so_dien_thoai || 'Chua cap nhat' }}</span>
                </td>
                <td class="text-center">
                  <button class="btn btn-sm btn-outline-primary me-2" type="button" title="Sua">
                    <i class="bi bi-pencil-square"></i>
                  </button>
                  <button class="btn btn-sm btn-outline-danger" type="button" title="Xoa">
              ...
              <tr v-if="!isLoading && !filteredUsers.length">
                <td colspan="5" class="empty-state">
                  ...
                  <p>Khong tim thay nguoi dung hop le</p>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <div class="modal-body p-4">
            <form @submit.prevent="themNguoiDung">
              ...
              <div class="modal-footer mt-3 border-0 px-0 pb-0">
                ...
                <button type="submit" class="btn btn-primary modal-btn" data-bs-dismiss="modal">Thêm mới</button>
              </div>
            </form>
          </div>
        </div>
  ...
  methods: {
    layDataUser() {
      ...
      axios
        ...
        .catch((err) => {
          console.error(err);
          this.$toast?.error('Khong tim thay du lieu nguoi dung');
        })
        .finally(() => {
    ...
    themNguoiDung() {
      this.$toast?.success('Da nhan du lieu them nguoi dung');

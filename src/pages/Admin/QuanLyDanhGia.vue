            ...
            <td class="col-user">
              <div class="user-info">
                ...
                <div class="user-details">
                  <strong>{{ review.nguoi_dung?.ho_ten || 'Người dùng ẩn danh' }}</strong>
                  <span class="user-email">{{ review.nguoi_dung?.email || '' }}</span>
                </div>
              </div>
            </td>
            <td class="col-place">
      ...
      allReviews: [
        {
          ...
          trang_thai: 0,
          so_sao: 5,
          noi_dung: "Địa điểm cực kỳ tuyệt vời, không gian mang lại cảm giác cực kỳ thư giãn sau những giờ làm việc mệt nhoài. Từ nay đây sẽ là địa điểm dã ngoại hàng tuần của nhóm chúng tôi.",
          nguoi_dung: { ho_ten: "Trần Anh Khoa", email: "khoa.tran@gmail.com" },
          dia_diem: { ten_dia_diem: "Bà Nà Hills" }
        },
        {
          id: 2,
          trang_thai: 1,
          so_sao: 3,
          noi_dung: "Phong cảnh cũng được nhưng giá vé quá đắt so với trải nghiệm thực tế. Hơn nữa, việc xếp hàng vào cổng mất tới 45 phút dưới trời nắng gắt làm tôi thực sự kiệt sức. Cần cải thiện quy trình bán vé và soát vé ngay lập tức chứ kiểu này ai mà dám quay lại. Rất mong ban quản lý có biện pháp sớm nhất để nâng cao chất lượng dịch vụ ở đây.",
          nguoi_dung: { ho_ten: "Nguyễn Thị Mai", email: "mai.nguyen_22@yahoo.com" },
          dia_diem: { ten_dia_diem: "Bán đảo Sơn Trà" }
        },
        {
          id: 3,
          trang_thai: 0,
          so_sao: 1,
          noi_dung: "Nhân viên thái độ lồi lõm, không thân thiện.",
          nguoi_dung: { ho_ten: "Lê Văn Hùng", email: "lvhung_dn@gmail.com" },
          dia_diem: { ten_dia_diem: "Công viên APEC" }
        },
        {
          id: 4,
          trang_thai: 1,
          so_sao: 5,
          noi_dung: "Nước dùng bún bò ở đây rất ngon và đậm vị. Tuyệt cú mèo luôn ạ.",
          nguoi_dung: { ho_ten: "Đinh Thu Thuỷ", email: "thuthuy01@gmail.com" },
          dia_diem: { ten_dia_diem: "Bún bò Huế bà Ơi" }
        }
      ]
    }
  },

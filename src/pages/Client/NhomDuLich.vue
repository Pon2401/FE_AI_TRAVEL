          ...
          <div v-else class="groups-grid">
            <div v-for="g in joinedGroups" :key="g.id" class="group-card">
              ...
              <div class="gc-actions">
                ...
                <button v-if="!g.la_truong_nhom" class="btn-sm-danger" @click="leaveGroup(g)">
      ...
      <div class="modal-box">
        ...
        <div class="mform-group">
          ...
          <div class="invite-input-row">
            <input v-model="inviteEmail" class="mform-input" type="email" placeholder="email@example.com"
    ...
    <div v-if="showMembers" class="panel-overlay" @click.self="showMembers = false">
      <div class="panel-drawer">
        ...
        <div v-if="panelGroup?.la_truong_nhom" class="panel-invite">
          ...
          <div class="invite-input-row">
            <input v-model="panelInviteEmail" class="mform-input" type="email" placeholder="email@example.com"
...
const BASE_CD = 'http://127.0.0.1:8000/api/client/chuyen-di';

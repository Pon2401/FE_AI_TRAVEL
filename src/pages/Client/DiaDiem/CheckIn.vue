        ...
        <div class="container text-center">
          <div class="hero-content">
            <h1 class="page-title mb-2">
              Địa điểm Check-in <span class="text-gradient">Nổi Bật Đà Nẵng</span>
            </h1>
            <p class="page-subtitle">
              Khám phá những góc nhìn tuyệt mỹ, từ Cầu Vàng huyền thoại đến những bãi biển thơ mộng. Hãy để AI giúp bạn
              tìm ra điểm đến hoàn hảo cho bức ảnh tiếp theo.
            </p>

        ...
        <div class="container text-center">
          <div class="hero-content">
            <h1 class="page-title mb-2">
              Thế Giới Giải Trí <span class="text-gradient">Sôi Động & Hấp Dẫn</span>
            </h1>
            <p class="page-subtitle">
              Trải nghiệm năng lượng bất tận tại những khu vui chơi hàng đầu châu lục. Tối ưu thời gian và ngân sách vui
              chơi với những quy hoạch thông minh từ AI.
            </p>
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      this.error = null;
      try {
        const res = await clientApi.get('/dia-diems/giai-tri');
        const json = res.data;
        const fallbacks = {

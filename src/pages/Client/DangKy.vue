                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center bg-branding position-relative overflow-hidden p-5 text-center">
                                ...
                                <div class="position-relative z-index-1 text-white">
                                    <div class="logo-icon bg-white text-primary rounded-circle d-inline-flex align-items-center justify-content-center shadow-lg mb-4" style="width: 80px; height: 80px;">
                                    ...
                                    <div class="form-body mt-4">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-group bg-light rounded-3 transition-all">
                                                    <span class="input-group-text border-0 bg-transparent text-primary px-3">
                                                        <i class="fa-regular fa-user"></i>
                                                    </span>
                                                    <input v-model="user.ten" type="text" class="form-control border-0 bg-transparent fs-6" placeholder="Nguyễn Văn A">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-group bg-light rounded-3 transition-all">
                                                    ...
                                                    <input v-model="user.email" type="email" class="form-control border-0 bg-transparent fs-6" placeholder="email@example.com">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="input-group bg-light rounded-3 transition-all">
                                                    ...
                                                    <input v-model="user.so_dien_thoai" type="text" class="form-control border-0 bg-transparent px-1 fs-6" placeholder="09xx">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="input-group bg-light rounded-3 transition-all">
                                                    ...
                                                    <input v-model="user.cccd" type="text" class="form-control border-0 bg-transparent px-1 fs-6" placeholder="0012...">
                                                </div>
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label fw-semibold text-secondary small">Ngày Sinh</label>
                                                <input v-model="user.ngay_sinh" type="date" class="form-control bg-light border-0 rounded-3 px-3 fs-6 transition-all" style="height: 38px;" min="1900-01-01" max="2025-12-31">
                                            </div>
                                            ...
                                            <div class="col-sm-6 mt-4">
                                                ...
                                                <div class="input-group bg-light rounded-3 transition-all">
                                                    ...
                                                    <input v-model="user.mat_khau" type="password" class="form-control border-0 bg-transparent fs-6" placeholder="••••••••">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 mt-4">
                                                ...
                                                <div class="input-group bg-light rounded-3 transition-all">
                                                    ...
                                                    <input v-model="user.re_password" type="password" class="form-control border-0 bg-transparent fs-6" placeholder="••••••••">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 mt-4">
                                                <div class="form-check">
                                                    <input class="form-check-input border-secondary" type="checkbox" id="termsCheck">
                                        ...
                                        <div class="text-center mt-4">
                                            <p class="text-muted small mb-0">Bạn đã có tài khoản?
                                                <router-link to="/client-login" class="text-primary fw-bold text-decoration-none ms-1 hover-underline">
                                                    Đăng nhập tại đây
                                                </router-link>
                                            </p>
                                        </div>
            ...
            axios.post('http://127.0.0.1:8000/api/client/dang-ky', this.user)
                .then((res) => {
                    if (res.data.status) {
                        ...
                        // Backend validation format typically comes in arrays if using Laravel Request validation
                        let msg = res.data.message || 'Đăng ký tài khoản thất bại';
                        this.$toast.error(msg);
                    }
                }).catch((error) => {
                    this.$toast.error('Lỗi kết nối hoặc dữ liệu không hợp lệ!');
                });
        }
    },
}
